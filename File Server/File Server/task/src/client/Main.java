...
public class Main {
    ...
    public static void transmitFile(String filename, DataOutputStream output) throws IOException {
        String filePath = "/Users/andrey/Projects/JavaDeveloperJB/File Server/File Server/task/src/client/data/" + filename;
    ...
    public static void receiveFile(DataInputStream input) throws IOException {
        ...
        String filePath = "/Users/andrey/Projects/JavaDeveloperJB/File Server/File Server/task/src/client/data/" + saveName;
